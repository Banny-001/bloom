<x-guest-layout>
    ...
    <x-auth-card>
        <x-slot name="logo">
            <img src="/resources/images/pink petal.jpg">
    ...
    <div class="text-center my-4">
        ...
        <div class="w-3/5 mx-auto mt-4">
          ...
          class="focus:ring-2 focus:ring-indigo-800 focus:ring-offset-4  flex items-center" >
          <svg xmlns="http://www.w3.org/2000/svg" width="25" heigth="25" 
          ...
          <span class="text-sm text-left ml-4 btn btn-primary ">Continue with Google</span>
